...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "  $pyPaths = @(" ^
  "    (Join-Path $repoRoot 'packages\pybinding\src')," ^
  "    (Join-Path $repoRoot 'research\world_model\src')" ^
  "  );" ^
  "  $env:PYTHONPATH = [string]::Join(';', $pyPaths);" ^
